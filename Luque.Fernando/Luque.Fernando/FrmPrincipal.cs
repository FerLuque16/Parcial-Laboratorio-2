...
namespace Luque.Fernando
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void rojoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se cargo el aula", "ERROR", MessageBoxButtons.OK);
            }
            else
            {
                MessageBox.Show("Se cancelo el alta de aula", "", MessageBoxButtons.OK);
            }
        ...
        private void cargarPruebaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Se han cargado las personas", "", MessageBoxButtons.OK);

            cargarPruebaToolStripMenuItem.Visible = false;//Hago el boton invisible para que no se puedan crear otra vez las mismas personas
